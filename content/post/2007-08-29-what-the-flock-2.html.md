...
Shame on Flock for this.  They should at least show a popup the first time that you drag an image, to warn the user what this does and that it is a bad practice to steal bandwidth like that.
